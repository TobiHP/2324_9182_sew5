...
echo k1cm:k1cm\.379\,GRM\_ | chpasswd
...
echo k3cm:k3cm\_377\.PRS\_ | chpasswd
...
echo k2bf:k2bf\,219\_STE\^ | chpasswd
...
echo k3bfn:k3bfn\%277\_BAA\- | chpasswd
...
echo k1ci:k1ci\#265\_JAV\^ | chpasswd
...
echo k2ci:k2ci\_271\_NIC\# | chpasswd
...
echo k3ci:k3ci\,225\.BRE\% | chpasswd
